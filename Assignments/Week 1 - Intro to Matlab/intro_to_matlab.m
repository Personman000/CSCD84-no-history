...
A(2a,:)              % Sometimes we just want a slice from a given index to the end of the
...
id=intersect(i1,i2);    % Take the intersection. i2'id' will be a vector with the indexes of
