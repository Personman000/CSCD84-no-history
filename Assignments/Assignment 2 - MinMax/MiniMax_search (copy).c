 ...
 */
 ...
 // Retreat if cat gets closer than cheese
 if(min_cat_distance < min_cheese_distance)
 {
 	min_distance = min_cat_distance - min_cheese_distance;
 }
